...
public class PanelOperario extends JPanel {
	...
	private JTextField textoFecha1;
	private JTextField textoFecha2;
	...
	public PanelOperario() {
		...
		textoFecha1 = new JTextField("");
		fixedSize(textoFecha1, 150, 30);
		textoFecha2 = new JTextField("");
		fixedSize(textoFecha2, 150, 30);
